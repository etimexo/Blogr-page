  ...
  return (
    <header className="container-fluid">
        ...
        <ul className="nav-menu">
          <li className="nav-item" id="product">
            <a href="#" className="nav-link">
              ...
              <span>
                ...
                <img className="dark" src={Dark} alt="Dropdown arrow" />
              </span>
            </a>
          </li>
          ...
          <li className="nav-item" id="connect">
            <a href="#" className="nav-link">
              Connect{" "}
              <span>
                <img className="light" src={Down} alt="Dropdown arrow" />
                <img className="dark" src={Dark} alt="Dropdown arrow" />
              </span>
            </a>
      ...
      <div className="content">
        <p className="modern">
          A modern <br className="break" /> publishing platform
        </p>
        <p className="m2">
          Grow your online audience and build your online brand
        </p>
